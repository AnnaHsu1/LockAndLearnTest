    ...
    >
      <View style={styles.containerFile}>
        <View style={styles.containerTitle}>
          <Text style={styles.selectFiles}>Choose files to add to your Work Package:</Text>
        ...
        >
          ...
          >
            ...
            <Text numberOfLines={2} ellipsizeMode='middle' style={[styles.fileName, { maxWidth: maxTextButtonWidth }]}>{fileDeleteName}</Text>
