  ...
  const handleSaveQuestion = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        await updateQuestionApproval(quizId);
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            style={[
              ...
              isFormValid() ? styles.saveQuestionButtonEnabled : styles.saveQuestionButtonDisabled,
            ]}
            onPress={() => {
          ...
          >
            <Text style={styles.saveQuestionButtonText} testID="save-button">
              Save
            </Text>
          </TouchableOpacity>
        </View>
