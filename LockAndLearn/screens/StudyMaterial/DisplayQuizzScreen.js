      ...
      <View style={styles.containerFile}>
            ...
            <View style={styles.multipleChoiceContainer}>
              {optionsAnswer.map((option, index) => (
                <View key={option.id} style={styles.multipleChoiceRow}>
                  <Text style={styles.multipleChoiceText} testID={`option-text-${option.id}`}>
                    {option.text}
                  </Text>
                  <CheckBox
              ...
              {inputs.map((input, index) => (
                <View key={index} style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <TextInput
                    ...
                    onChangeText={(text) => handleInputTextChange(text, index, questionIndex)}
                  />
                </View>
              ))}
            </>
        ...
        <View style={styles.buttonContainer}>
          ...
          {questionIndex <= quizLength - 2 && (
            ...
            >
              <Text style={styles.nextButtonText} testID="save-button">
                Next
              </Text>
            </TouchableOpacity>
          )}
          {questionIndex === quizLength - 1 && (
            ...
            >
              <Text style={styles.finishQuizButtonText} testID="save-button">
                Finish Quiz
              </Text>
            </TouchableOpacity>
          )}
