    ...
    return (
        <View style={styles.page}>
            <View style={styles.container}>
                ...
                >
                    <View style={{ backgroundColor: 'white', borderRadius: 20, padding: 20, minHeight: hp('20%') }}>
                        <Text style={styles.title}>{fdata.FirstName} {fdata.LastName} has been added successfully!</Text>
                        <Button style={styles.button} title="Hide modal" onPress={() => { toggleModal(); navigation.navigate('ParentAccount') }}><Text style={styles.close}>Close</Text></Button>
                    </View>
                </Modal>
            </View>
