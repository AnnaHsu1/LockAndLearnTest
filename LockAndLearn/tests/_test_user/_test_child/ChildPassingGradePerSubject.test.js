...
describe('ChildPassingGradePerSubject Screen test', () => {
  ...
  it('Updates user subjects and navigates on success', async () => {
    ...
    await waitFor(() => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(`https://data.mongodb-api.com/app/lock-and-learn-xqnet/endpoint/updateUserSubjectsPassingGrade?id=child123`, expect.anything());
